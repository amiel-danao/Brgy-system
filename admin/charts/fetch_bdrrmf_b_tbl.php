...
$sql = "SELECT year, aipcode, SUM(totalbudgetallocation) as total_sum FROM bdrrmf_b_tbl";
if (!empty($brgyCode)) {
    $sql .= " WHERE brgy_code = '$brgyCode'";
}
$sql .= " GROUP BY year, aipcode ORDER BY year, aipcode";
