                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left  mx-auto">
                                      <h2 class="text-center text-uppercase">Barangay Official full Information</h2>
                                    </div>
                                </div>
                            <!--</div>-->
                            <!--<div class="col-md-offset-2">-->
...
if (isset($_GET['barangayid']))
{
    ...
    $stmt->execute();
    $stmt->bind_result($brgy_id,$first_name,$last_name,$middle_name,$gender,$age,$bod,$birth_of_place, $address,$email,$contact_no,$religion,$civil_status,$highest_education,$educstatus,$course_school,
         $occupation,$brgy_code,$barangay,$position,$term,$dateelec,$picture,$post);
    $stmt->fetch();
    $stmt->close(); 
}
 ?>
 ...
 <!--  <form action="" method="post" enctype="multipart/form-data" class="form-horizontal"  name="barangay_official"> -->
    <!-- <fieldset disabled> -->
        <div class="row">
<div class="col-md-1">
...
<div class="pull-right mx-auto col-md-6 mt-5">
   ...
   <!--  </fieldset> -->
        ...
        <div class="row form-group">
            <div class="col col-md-5">
                <label for="Gender" class=" form-control-label font-weight-bold">Select Gender</label>
            </div>
            <div class="col-12 col-md-7">
                <!-- <input type="text" id="Mname" name="Mname" class="form-control bg-light" required
                value="" readonly="readonly"> -->
    ...
    <div class="row form-group">
        ...
        <div class="row form-group">
            <div class="col col-md-5">
                <label for="religion" class=" form-control-label font-weight-bold">Select Religion</label>
            </div>
            <div class="col-12 col-md-7">
                 <!--  <input type="text" id="contactno" name="contactno" class="form-control bg-light" required
                value="" readonly="readonly"> -->
        ...
        <div class="row form-group">
            <div class="col col-md-5">
                <label for="status" class=" form-control-label font-weight-bold">Select Civil Status</label>
            </div>
            <div class="col-12 col-md-7">
                <!--  <input type="text" id="contactno" name="contactno" class="form-control bg-light" required
                value="" readonly="readonly"> -->
        ...
        <div class="row form-group">
            <div class="col col-md-5">
                <label for="education" class=" form-control-label font-weight-bold">Select Higher Education Attain</label>
            </div>
            <div class="col-12 col-md-7">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-7">
                ...
                value="" readonly="readonly"> -->
                <label for="educstatus" class=" form-control-label"><?php echo $educstatus ?></label>
            </div>
        </div>
