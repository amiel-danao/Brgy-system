    ...
    while ($data = $result->fetch_assoc())
        {
            ...
            $username  = $data['username'];
                    ...
                    ?>
                    <tr>
                        <td class="text-center"><?php echo $first_name ?></td>
                        <td class="text-center"><?php echo $last_name ?></td>
                        <td class="text-center"><?php echo $username ?></td>
                        <td class="text-center"><?php echo $email ?></td>
                        <td class="text-center"><a href="edit-account.php?edit_account=<?php echo $id ?>" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Update</a>
                        </td>
                    </tr> 
                </tbody>
            </table>
