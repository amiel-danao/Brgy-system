...
<div class="row">
  ...
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
	...
	<div>
					<p>Ang Barangay Garita-A ay isa sa 27 na barangay sa Maragondon, Cavite. Dati itong sitio ng Barangay Caputatan na ngayon ay Barangay San Miguel na sinasabing ang naturang Sitio ay nahihiwalay sa Barangay Caputatan noong taong 1935, kaya naman ito’y naging Barangay Garita.</p>
	</div>	
				<section>
					<div class="text-center">
						<h5 class="font-weight-bold">LEGAL NA BASEHAN NG PAGKAKATATAG NG BARANGAY:</h5>
					</div>
					<hr>	
						<p>Isang referendum ng R.A 7160 o kilala sa tawag na Local Government Code of 1991. Ayon sa mapa ito ay matatagpuan sa:</p>

						<!-- <p class="text-center">Hilaga (NORTH)			- Barangay San Miguel</p>
						<p class="text-center">Timog (SOUTH)			- Barangay Poblacion 2B</p>
						<p class="text-center">Silangan (EAST)			- Barangay Bucal 1</p>
						<p class="text-center">Kanluran (WEST)			- Baragay Garita-B at Bayan ng Ternate</p> -->

						<ul class="">
						    <li>Hilaga (NORTH)			- Barangay San Miguel</li>
						    <li>Timog (SOUTH)			- Barangay Poblacion 2B</li>
						    <li>Silangan (EAST)			- Barangay Bucal 1</li>
						    <li>Kanluran (WEST)			- Baragay Garita-B at Bayan ng Ternate</li>
						</ul>
						<p>Ang barangay ay isang uri at nabibilang sa klasipikasyong RURAL. Ito ay may kabuuang lawak ng lupain na 74,949 ektarya (74.95hec.). Ang lawak ng lupain ito ay kinapapalooban ng Residensyal, Pangsakahanm, Pangkomersyal at iba pa.</p>
	<h5 class="font-weight-bold text-center text-uppercase">Mga Pista / Selebrasyon at Petsa</h5>
<hr>
	<!-- <p class="text-center">*Oktubre 24			- Selebrasyon ng San Rafael Arcangel (Santo ng Mangingisda) </p>
	<p class="text-center">*Agosto 15			- Araw ng Kapistahan Nuestra Senora De La Asuncion</p>
	<p class="text-center">*September 7			- Maragondon Day</p> -->
<ul class="">
    <li>Oktubre 24			- Selebrasyon ng San Rafael Arcangel (Santo ng Mangingisda)</li>
    <li>Agosto 15			- Araw ng Kapistahan Nuestra Senora De La Asuncion</li>
    <li>September 7			- Maragondon Day</li>
	...
	<section>
		<div class="text-center">
			<h5 class="font-weight-bold text-uppercase">GEOGRAPHICAL LOCATION </h5>
		</div>
		<hr>	
			<p>Caingin Poblacion is situated at approximately 14.2705, 120.7384, in the island of Luzon. Elevation at these coordinates is estimated at 21.9 meters or 71.8 feet above mean sea level. Located at Municipality Maragondon Cavite, they have five streets called Capt.) Rillo st. Comandante de leon st. Villa Franca st. A RILLO st. and B RILLO st. 
Barangay Hall is located at gitnang Caingin. We aslo have a cover court it has a 70 meters away from Barangay Hall and we have a Multi Purpose and it has a 40 meters away from Barangay Hall. 
</p>
	</section>	
