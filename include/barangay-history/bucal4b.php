...
<div class="row">
  ...
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
	...
	<div>
				<p>Ang Barangay Bucal 4B ay kabilang sa (27) Barangay na nasasakupan ng Munisipalidad ng Maragondon, lalawigan ng Cavite. Maari itong puntahan sa pamamagitan ng kahit anong uri ng sasakyan panlupa na kung saan tatahakin ay ang kahabaan ng konkretong daanan ng Maragondon, ito ay may higit kumulang apat (4) na kilometro ang layo simula sa Silangang papunta sa Bayan ng Maragondon.</p>

				<p>Ang Bucal ay may kaugnayan sa pinagmulan ng pangalan ng Maragondon. Ang pangalang Bucal ay nakuha sa kwento ng ilog ng buong Barangay na may maraming bukal na
nagpapakawala ng tubig. Ang kwento ng Bucal, ito ay iisa lamang na Barangay dahil sa referendum bago ang taong 1990. Noong una ang buong barangay ay tinatawag lamang “BUCAL” pero noong ito ay nahati-hati na sa ibat-ibang barangay ay tinawag itong Bucal I, II, III, at IV. Ang Bucal IV ay hinati sa dalawang bahagi bilang Bucal IV-A at Bucal IV-B. Ang pinakaunang kapitan ng Barangay ay si Bonifacio Enriquez.
</p>

				<h5 class="font-weight-bold text-center">LEGAL NA BASEHAN ANG PAGKAKATATAG NG BARANGAY</h5>
				<hr>
				<p>Isang referendum ng R.A 7160 o kilala sa tawag na Local Government Code of 1991.</p>						
	</div>	
				...
				<section>
					...
					<hr>	
	<ul>
	    <li>Mayo 15 ------------------------------------ Selebrasyon ng San Isidro Labrador(Santo ng magsasaka)</li>
	    <li>Ikahuling Linggo ng Mayo  ------------------------------------ Santa Cruzan</li>
	    <li>Hunyo 12 ------------------------------------ Araw ng Kalayaan</li>
	    <li>Hunyo 12-13 ------------------------------------ Araw ng Kapistahan ng Mahal na Patron     
San Antonio de Padua</li>
	</ul>
						
					
			<h5 class="font-weight-bold text-center text-uppercase">Ang Barangay Bucal 4B ay napapalibutan ng mga sumusunod na barangay:</h5>
	<hr>
	<ul>
	    <li>Hilaga (North)		:	Barangay Muzon, Naic</li>
	    <li>Timog (South)		:	Barangay Tulay A & Tulay B</li>
	    <li>Silangan (East)		:	Barangay Sitio Pasong Malainen </li>
	    <li>Kanluran (West) 	:	Barangay Bucal 4A</li>
	</ul>
