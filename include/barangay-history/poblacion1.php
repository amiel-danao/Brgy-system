...
<div class="row">
  ...
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
	...
	<div>
				<p>Walang naitalang kasaysayan ng Barangay Poblacion 1-A kundi ang barangay na ito at ang Poblacion 1-B ay iisang barangay na kilala bilang Poblacion 1. Sa kadahilanan ng paglaki ng populasyon at pagdami ng mga pangangailangan ng mga kabarangay kaya ito ay nahati sa dalawa, ang isa na nga dito ay ang Poblacion l-A. </p>
...
<section>
	...
	<hr>	
		<p>Wala ding napag-alaman at makukunang mga datos para sa legal na basehan ng pagkakatatag ng Barangay Poblacion l-A bilang isang barangay. </p>

		<h5 class="font-weight-bold text-center">MGA PISTA / SELEBRASYON AT PETSA</h5>
<hr>
		<ul>
		    <li>Mahal na araw---------------------------------Marso o Abril </li>
		    <li>Pista ng Nuestra Senora de la Asuncion---------Agosto 15 </li>
		    <li>Undas ------------------------------------------- Nobyembre 1 </li>
		    <li>Pasko --------------------------------------------Disyembre 25</li>
		    <li>Bagong Taon -------------------------------------------Enero 1 </li>
		</ul>

		<h5 class="font-weight-bold text-center text-uppercase">Pisikal na Anyo</h5>
		<hr>
<p>Lokasyong Pangheyograpiya (Geographical Location) 
Ang Barangay Poblacion 1-A ay nalulugar sa bayan ng Maragondon. Ito ay napalilibutan ng mga sumusunod na barangay 
</p>
<h5 class="font-weight-bold ml-3">
VID<h5>
		<ul>
		    <li>Hilaga (North) 		:		Barangay Garita A </li>
		    <li>Timog (South) 		:		Barangay Poblacion 1-B </li>
		    <li>Silangan (East) 		:		Barangay Poblacion 2 </li>
		    <li>Kanluran (West) 		:		Barangay Garita B </li>
		</ul>
</section>			
