...
<div class="row">
  ...
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
	...
	<div>
					<p>Walang naitalang kasaysayan ang Barangay Poblacion 1-B, kundi ang Barangay na ito at Poblacion 1-A ay iisa na kilala bilang Poblacion 1, sa kadahilanang paglaki ng populasyon at pagdami ng pangangailangan ng mga nasasakupan nito ay nahati sa dalawa, at ang isa nga ditto ay Poblacion 1-B.</p>
	</div>			
				<section>
					<div class="text-center">
					...
					<hr>	
						<p>Ang legal na Basehan ng Poblacion 1-B ay naayon sa batas REPUBLIC ACT 3590 na layunin na magkaroon ng tamang basehan ang bawat Barangay.</p>

						<h5 class="font-weight-bold text-center">MGA PISTA / SELEBRASYON AT PETSA:</h5><hr>
				<ul>
				    <li>Pista ng Nuestra señora Dela Asuncion- ipinagdiriwang ito tuwing ika- 15 ng Agosto.</li>
				    <li>Pista ng San Nicolas De Tolentino- ipinagdiriwang tuwing ika-10 ng Setyembre.</li>
			
				</ul>
						<!-- <p>Pista ng Nuestra señora Dela Asuncion- ipinagdiriwang ito tuwing ika- 15 ng Agosto.</p>
						<p>Pista ng San Nicolas De Tolentino- ipinagdiriwang tuwing ika-10 ng Setyembre.</p> -->

						
						<h5 class="font-weight-bold text-center">PISIKAL NA ANYO</h5>
						<hr>
						<p>Locasyon Pangheograpiya (Geographical Location)</p>
						<p>Ang Barangay Poblacion 1-B ay humigit 0.8 kilometro mula sa kabayan ng Maragondon. Ito ay napalilibutan ng mga iba pang ka-barangay. Ang Poblacion 1-B ay may populasyon na 1,334 (CY 2017) bilang isang libo tatlong daan tatlumpu’t - apat ay may nakatalang bilang ng pamilya ay 325. Ang pangunahing relihiyon ditto ang Romano Katoliko. Pangunahing hanapbuhay rito ay pagsasaka, pangingisda at pagnenegosyo.</p>
				</section>		
...
<!-- End History Part -->
  ...
  <?php $MYsql3 = "SELECT * FROM `barangay_vision_tbl` WHERE `bcode`=?";
...
$numberv =1 ;
    ...
    <p class="font-italic">“<?php echo $data['vision']; ?>”</p>
  <?php } ?>
    </div>
  </section>
  ...
  <hr>  
    ...
    <div class="ml-3 mr-3 text-center">
    <?php $MYsql2 = "SELECT * FROM `barangay_mission_tbl` WHERE `bcode`=?";
    ...
    <p class="font-italic">“ <?php echo $data['mission']; ?>”</p>
  <?php } ?>
    </div>
  </section>
  ...
  <?php 
        ...
        $result = $stmtg->get_result();
          while ($data = $result->fetch_assoc())
                  {
?>            <p class="font-italic">“ <?php echo $data['goal']; ?>”</p>
          <?php } ?>
      </div>
    </section>      
      </div>
