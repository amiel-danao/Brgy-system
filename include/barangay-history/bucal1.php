...
function getsizehh($bcode){  
global $db; 
  $sql = "SELECT no_of_hh, COUNT(no_of_hh) AS fooCount 
FROM `residents_tbl` WHERE `brgy_code`= ? 
GROUP BY no_of_hh
ORDER BY COUNT(no_of_hh) DESC LIMIT 1 ";
  $stmt = $db->prepare($sql);
  $stmt->bind_param('s',$bcode);
  $stmt->execute();
  $stmt->bind_result($sizehh,$sizehhs);
  $stmt->fetch();
  $stmt->close();
  return $sizehh;
}
...
<div class="row">
  <div class="col-md-3">
    <div class="nav flex-column nav-pills border-dark" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      ...
      <a class="nav-link" href="organizational.php?barangay=<?php echo $bcode ?>"  style="border: 1px solid black;">Organizational Chart</a>
  ...
  <div>
          <p>Ayon sa kasaysayan ang Bukal -1 ay hango sa mga tubig na bumabalong mula sa mga balon. Dahil dati ay maraming balon na bumabalong na kadalasang nakikita tuwing tag-ulan. At meron ding isang maliit na bahagi  ang bukal -1 na noon ay tinatawag na Pulong Ipot dahil noong araw raw sabi-sabi ng matatanda halos lahat raw ng residente dito ay may mga alagang manok, na di kalaunan ay tinatawag na ngayong Kapantayan Street. at dito itinayo ang munting Barangay Hall ng Bucal-1.</p>
         <!--  At ang Punong Barangay dito ay si KGG. TROJAN CARLO R. ESEQUE. -->
        
          <p>Ang Barangay Bucal – 1 ay pangalawa sa pinaka Malaki sa binubuo ng 27 Barangay ng Maragondon, Cavite At napapalibutan ito ng mga ibang Barangay sa hilangang bahagi ay ang Bayan ng San Miguel, bahaging timog ay Barangay Layong Mabilog, silangang bahagi ay ang Barangay Bucal- 2, at ang kanlurang bahagi naman ay ang Barangay Caingin at Poblacion- 2, Ang mga mamamayan dito o residente sa Barangay Bucal- 1 ay may ugaling relihosa o tinatawag na malapit sa ating Poong Maykapal. Karamihan dito ay Katoliko, Aglipayan, at meron ring Born Again at iba pang sekta ng relihiyon.</p>

          <p>Ang pangunahing ikinabubuhay ng mga residente dito lalo na sa Kapantayan St. ay paggawa ng mga stick. ito ang pangunahing pinagkakakitaan dito. At mayroon ding mga residente na ang kabuhayan ay ang pagsasaka, may lawak itong 45 hectarya napatubigan.
          Ang mga pangunahing produktong gawa dito at maipagmamalaki ng mga tao sa Barangay Bucal- 1, isa na dito ang mga stick, bigas, prutas at mga gulay.
          </p>
  </div>
  </div>
<!-- End History Part -->
  ...
  // $numberv =1 ;
    ...
    <p class="font-italic text-center">“<?php echo $data['message']; ?>”</p>
  <?php } ?>
    </div>
  </section>
  ...
  $goal = "goal";
        ...
        // $sqlg = "SELECT * FROM `barangay_goal_tbl` WHERE `bcode`=? ";
        // $stmtg = $db->prepare($sqlg);
        // $stmtg->bind_param('s',$bcode);
        // $stmtg->execute();
        // $result = $stmtg->get_result();
      ...
      <tr>
       ...
       <tr>
        <th >Average HH Size</th>
         <th ><?php echo $sizehh = getsizehh($bcode);?></th>
      </tr>
...
<?php 
  ...
  COUNT(*)  FROM `residents_tbl` WHERE `brgy_code`= ? ";
   ...
   <tr>
      <td class="font-weight-bold text-center">TOTAL</td>
      <?php $totalm = $a1m + $a2m + $a3m + $a4m + $a5m + $a6m;
  $totalf = $a1f + $a2f + $a3f + $a4f + $a5f + $a6f;
...
<div class="col-md-12">
   <div class="table-responsive">
      <table class="table table-bordered">
        <thead class="border-0">
          <tr>
            <th class="text-center">Types of Religion</th>
            <th class="text-center">Population</th> 
            <th class="text-center">%</th>
          </tr>
        </thead>
...
<section>
    <div class="pull-left">
      <h5 class="font-weight-bold"><p>School Population Distribution</p></h5>
    </div>
  </section>
    ...
    $total16 = 0;$total17 = 0;$total18 = 0;
     ...
     ?>
        ...
        <tr>
            ...
            <td class="text-center font-weight-bold"><?php echo $total1 ?></td>
        </tr>
        <tr>
            ...
            <?php  $total2 = $elm1 + $elf1; ?>
             <td class="text-center font-weight-bold"><?php echo $total2 ?></td>
        </tr>
        <tr>
            ...
            <td class="text-center font-weight-bold"><?php echo $total3 ?></td>
        </tr>
        <tr>
            ...
            <td class="text-center font-weight-bold"><?php echo $total4 ?></td>
        </tr>
        <tr>
            ...
            <td class="text-center font-weight-bold"><?php echo $total5 ?></td>
        </tr>
        <tr>
            <td>Vocational</td> 
            ...
            <td class="text-center font-weight-bold"><?php echo $total6 ?></td>
        </tr>
        <tr>
            ...
            <td class="text-center font-weight-bold"><?php echo $total7 ?></td>
        </tr>
        <tr>
            <td>Academic Degree Holder</td>
            <td class="text-center"><?php echo $cdm1 ?></td>
            <td class="text-center"><?php echo $cdf1 ?></td>
            <?php  $total8 = $cdm1 + $cdf1; ?>
            <td class="text-center font-weight-bold"><?php echo $total8 ?></td>
        </tr>
        <tr>
            ...
            <td class="text-center font-weight-bold"><?php echo $total9 ?></td>
        </tr>
        <tr>
            <td class="font-weight-bold text-center">TOTAL</td>
            <?php 
                ...
                $total8 + $total9 ;
             ?>
            <td class="text-center font-weight-bold"><?php echo $total10 ?></td> 
            <td class="text-center font-weight-bold"><?php echo $total11 ?></td>
            <td class="text-center font-weight-bold"><?php echo $total12 ?></td>  
        </tr>
        </tbody>
    </table>
  </div>
