...
<div class="row">
  ...
  <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
	...
	<div>
				<p>Barangay Poblacion 2-B was one of the smallest Barangays in Town Of Maragondon. Poblacion was divided into four. It is Poblacion 1A, Poblacion 1B, Poblacion 2A and our Barangay Poblacion 2-B. Poblacion 2-B played a significant role in the Philippine Revolution because the "Ancestral House of one of the heroes in Maragondon, who is Gen. Emiliano Riego de Dios, which is located at Gen.E. Riego de Dios St., Pob. 2-B, Maragondon, Cavite. His heroism is our pride and teaches us to be a hero in our Own way. </p>
		
	</div>	
<section>
	<div class="ml-3">
		<h5 class="font-weight-bold text-uppercase">CREATION OF BARANGAY POBLACION 2-B</h5>
	</div>
	<hr>	
		<p>Barangay Poblacion , being one of the largest and most populated barangays in the Municipality of Maragondon, and it was divided into four barangays, namely, Poblacion 1-A, Poblacion 1-B, Poblacion 2-A and Poblacion 2-B. They are tasked with ensuring peace and order through settlement of petty quarrels among neighbors, screening newcomers in the barangay, supervision of social activities and meet the needs and please of residents. </p>

		<h5 class="font-weight-bold text-center">GEOGRAPHICAL LOCATION </h5>
<hr>
		<p>Barangay Poblacion 2-B is located at one of the highest parts of the Municipality of Maragondon. It is surrounded by the four Barangay in the south Barangay Caingen, in the north, a portion of Barangay Poblacion 2-A and Barangay Poblacion 1-B in the west and Barangay Bucal i in the east, it has land area measuring 3.6543 hectares of residential land. </p>
