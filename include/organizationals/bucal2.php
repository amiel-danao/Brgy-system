                ...
                <div class="col-lg-12" id="org">
                    <div class="card">
                        <div class="card-header text-center">
                            <strong>Barangay Organizational Chart of Bucal 2</strong>
                        </div>
            ...
            <div class="col-md-3 mx-auto organizational mt-3">
                <div class="card mx-0">
                  <div class="card-header bg-info"><h6 class="text-center"><?php echo $position ?></h6></div>
                    <img class="card-img-top mx-auto img-fluid" src="bucal2/bimages/<?php echo $picture ?>" alt="Card image cap" style="width:80px;height: 80px;">
                    <div class="card-body">
