                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left mx-auto">
                                      <h2 class="text-center text-uppercase">Update Barangay Official Form</h2>
                                    </div>
                                </div>
                            <!--</div>-->
                            <!--<div class="col-md-offset-2">-->
...
//     $stmt->bind_result($brgy_id,$first_name,$last_name,$middle_name,$gender,$age,$bod,$birth_of_place,
//         $address,$email,$contact_no,$religion,$civil_status,$highest_education,$educ_status,
//         $course_school,$occupation,$brgy_code,$barangay,$position,$term,$dateelec,$picture);
//     $stmt->fetch();
//     $stmt->close();
    ...
    <input type="hidden" name="brgy_code" value="<?php echo $brgy_code ?>">
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="number" id="brgyid" name="brgyid"  class="form-control" required
   ...
   <!--  </fieldset> -->
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-2">
                <select name="Gender" id="Gender" class="form-control-sm" required>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" id="bop" name="bop" class="form-control" required
    ...
    <div class="row form-group">
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" id="contactno" name="contactno" class="form-control" maxlength="11" required placeholder="11 digits Cellphone Number Ex. 09000000000" value="<?php echo $contact_no ?>">
            </div>
        </div>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <select name="religion" id="religion" class="form-control-md form-control" required>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <select name="status" id="status" class="form-control-md form-control" required>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <select name="education" id="education" class="form-control-md form-control" required>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <select name="Specify" id="Specify" class="form-control-md form-control" required>
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
                <input type="text" id="school" name="school" class="form-control" required value="<?php echo $course_school ?>" maxlength="70">
            </div>
        </div>

        <div class="row form-group">
            <div class="col col-md-3">
                <label for="Occupation" class=" form-control-label">Occupation Status</label>
            </div>
            <div class="col-12 col-md-9">
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
            <select name="brgy_official_position" id="brgy_official_position" class="form-control" required>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-2">
            <select name="Term" id="Term" class="form-control-sm" required="required">
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-9">
            <select name="brgy_name" id="brgy_name" class="form-control-md form-control" required>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        //     var deleteurl = "include/function/process.php?remove_id="+ id +" ";
