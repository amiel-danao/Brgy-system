<?php  
    ...
    include('include/function/sms_residents_function.php'); 
?>
                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content mx-auto">
                                    <div class="au-breadcrumb-left mx-auto">
                                      <h2 class="text-center">SEND SMS MESSAGE FORM FOR RESIDENTS</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-offset-2">
...
<input type="hidden" id="bcode" name="bcode" class="form-control" value="<?php echo $brgycode ?>">
    ...
    <div class="card-footer">
        <button type="submit" class="btn btn-primary btn-sm" name="sendsmsresidents">
            <i class="fa fa-paper-plane" aria-hidden="true"></i> SEND TO ALL RESIDENTS
        </button>
    </div>
    </form>
</div>
