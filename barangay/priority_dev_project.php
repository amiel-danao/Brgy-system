                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left mx-auto">
                                      <h2 class="text-center text-uppercase">pdp Add Form</h2>
                                    </div>
                                </div>
                            </div>
                            <!--<div class="col-md-offset-2">-->
...
<input type="hidden" id="bcode" name="bcode" class="form-control" value="<?php echo $brgycode ?>">
        <div class="row form-group">
         ...
         <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                <input type="text" id="program" name="program"  class="form-control" maxlength="120">
        ...
        <div class="card-footer">
		    <button type="submit" class="btn btn-primary btn-sm" name="addPDP">
