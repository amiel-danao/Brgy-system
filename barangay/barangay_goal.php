                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content mx-auto">
                                    <div class="au-breadcrumb-left mx-auto">
                                      <h2 class="text-center">ADD NEW BARANGAY GOAL</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-offset-2">
    ...
    <input type="hidden" id="bcode" name="bcode" class="form-control" value="<?php echo $brgycode ?>">
        ...
        <div class="row form-group">
            <div class="col col-md-3">
                <label for="Goalmessage" class="form-control-label">Goal Message</label>
            </div>
            <div class="col-12 col-md-9">
            <textarea name="Goalmessage" id="Goalmessage" rows="6" class="form-control"></textarea>
            </div>
        </div>

    <div class="card-footer">
        <button type="submit" class="btn btn-primary btn-sm" name="barangaygoal">
            <i class="fa fa-paper-plane" aria-hidden="true"></i> ADD NEW GOAL
        </button>
    </div>
    </form>
</div>
