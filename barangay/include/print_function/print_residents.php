...
ob_start();
	...
	//Long Bond Paper 'mm',array(215.9,279.4)
			...
			$pdf->SetLineHeight(5);
	   if(isset($_GET['print']) && $_GET['print'] != null)
		{
			$code = $_GET['print'];
			// $pdf = new FPDF('P', 'mm', 'A4');
				$pdf->Image('../../logoimg/'. $code.'.png',95,3,40,35);
			$pdf->SetFont('Arial', 'BU', 13);
			
			$pdf->Cell(330 , 6,$_GET['bname'],0,1,'C');
			$pdf->Cell(330 , 6,'Barangay Residents Record',0,1,'C');
			$pdf->Cell(280 , 15,'',0,1);
		 	...
		 	$pdf->Cell(27 , 10,'college Status',1,1,'C');
				...
				$number = 0;
				 while ($data = $result->fetch_assoc())
				 	...
				 	$pdf->SetFont('Arial', '', 8);
				 	// $pdf->Cell(35 , 8,$data['first_name'],1,0);
				 	// $pdf->Cell(35 , 8,$data['last_name'],1,0);
				 	// $pdf->Cell(35 , 8,$data['middle_name'],1,0);
				 	// $pdf->Cell(20 , 8,$data['gender'],1,0);
				 	// $pdf->Cell(25 , 8,$data['bod'],1,0);
				 	// $pdf->Cell(20 , 8,$data['house_no'],1,0);
				 	// $pdf->Cell(35 , 8,$data['street'],1,0);
				 	// $pdf->Cell(55 , 8,$data['religion'],1,0);
