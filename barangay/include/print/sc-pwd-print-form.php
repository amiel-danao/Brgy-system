...
<div class="card">
    <div class="card-header">
        <strong>SC & PWD FILL UP FORM</strong>
    </div>
<div class="card-body card-block">
    <form action="<?php echo htmlspecialchars("include/print_function/sc_pwd.php"); ?>" method="POST" enctype="multipart/form-data" class="form-horizontal" target="_blank">
...
<input type="hidden" id="bname" name="bname" class="form-control" value="<?php echo $brgyname ?>">
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-6">
               <select name="quarter" id="quarter" class="form-control-md form-control" required>
                <option value="" selected="true" disabled="disabled">select Quarter</option>
    ...
    <div class="card-footer">
	    <button type="submit" class="btn btn-primary btn-sm" name="print_sc_pwd">
