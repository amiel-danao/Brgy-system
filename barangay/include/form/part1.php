<?php 
    ...
    {
        $key = $_GET['part1'];
        $MYsql1 = "SELECT * FROM `monthly_p1_tbl` WHERE `id` = ?";
        $mystmt1 = $db->prepare($MYsql1);
        $mystmt1->bind_param('i',$key);
        $mystmt1->execute();
        $mystmt1->bind_result($id,$description,$on_going_status,$completed_status,$started_date,
            $completed_date,$project_cost,$funds,$remarks,$month,$year,$brgycode);
        $mystmt1->fetch();
        $mystmt1->close();
...
<input type="hidden" id="bcode" name="bcode" class="form-control" value="<?php echo $brgycode ?>">
        <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $description ?>" maxlength="100">
            </div>
        </div>
         ...
         <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $on_going_status ?>" maxlength="40">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $completed_status ?>" maxlength="40">              
            </div>
        </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $started_date ?>" required="required" maxlength="40">               
            </div>
        </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $completed_date ?>" required="required" maxlength="40">           
            </div>
        </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $project_cost ?>" maxlength="20">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $funds ?>" maxlength="50">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $remarks ?>" maxlength="30">
        ...
        <div class="card-footer">
		    <button type="submit" class="btn btn-primary btn-sm" name="updatemonthly1">
