 <?php
        ...
        {
            $key = $_GET['part2'];
            $MYsql2 = "SELECT * FROM `monthly_p2_tbl` WHERE `id` = ? ";
            $mystmt2 = $db->prepare($MYsql2);
            $mystmt2->bind_param('i',$key);
            $mystmt2->execute();
            $mystmt2->bind_result($id,$title,$order_no,$description,$remarks,$type,$no,$date_conducted,$no_present,$no_absent,$month,$year,$brgycode);
            $mystmt2->fetch();
            $mystmt2->close();
...
<input type="hidden" id="bcode" name="bcode" class="form-control" value="<?php echo $brgycode ?>">
        <div class="row form-group">
         ...
         <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $order_no ?>" maxlength="20">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $description ?>" maxlength="80">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $remarks ?>" maxlength="50">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $type ?>" maxlength="50">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $no ?>" maxlength="20">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $no_present ?>" maxlength="5">
        ...
        <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $no_absent ?>" maxlength="5">
