<?php 
    ...
    if (isset($_GET['popsrecorda']))
            {
                $key = $_GET['popsrecorda'];
                $Mysql = "SELECT * FROM `pops_a_tbl` WHERE `id` = ? ";
                $Mystmt = $db->prepare($Mysql);
                $Mystmt->bind_param('i',$key);
                $Mystmt->execute();
                $Mystmt->bind_result($id,$ppsa,$implementing,$sdate,$cdate,
                $expectedoutput,$funding,$pservice,$mooe,$capital,$total,$title,$year,$brgycode);
                $Mystmt->fetch();
                $Mystmt->close();
            }
...
<div class="card">
    <div class="card-header">
        <strong>POPS A. PEACE AND ORDER Information</strong>
    </div>
...
<input type="hidden" id="bcode" name="bcode" class="form-control" value="<?php echo $brgycode ?>">
    <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            <input type="text" id="ppsa" name="ppsa" class="form-control" value="<?php echo $ppsa ?>" maxlength="60">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            ...
            value="<?php echo $implementing ?>" maxlength="100">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            ...
            value="<?php echo $sdate ?>" maxlength="30">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            ...
            value="<?php echo $cdate ?>" maxlength="30">
        </div>
    </div>
    ...
    <div class="row form-group">
      ...
      <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            ...
            value="<?php echo $funding ?>" maxlength="60">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            ...
            value="<?php echo $pservice ?>" maxlength="10">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            ...
            value="<?php echo $mooe ?>" maxlength="10">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            ...
            value="<?php echo $capital ?>" maxlength="10">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            ...
            value="<?php echo $total ?>" maxlength="10">
        </div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-12 col-md-8">
            <input type="text" id="title" name="title" class="form-control" value="<?php echo 
            $title ?>" maxlength="70">
        </div>
    </div>
     ...
     <div class="row form-group">
        ...
        <div class="card-footer">
		    <button type="submit" class="btn btn-primary btn-sm" name="updatepopsA">
