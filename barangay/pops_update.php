<?php  
    ...
    // if (!isset($_GET['popsrecorda']) && !isset($_GET['popsrecordb']))
    //     {
                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left mx-auto">
                                      <h2 class="text-center text-uppercase">pops Update Form</h2>
                                    </div>
                                </div>
                            </div>
                            <!--<div class="col-md-offset-2">-->
...
{
    include("include/form/popsa.php");
}
if (isset($_GET['popsrecordb']))
{
    include("include/form/popsb.php");
}
