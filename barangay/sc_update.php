<?php  
    ...
    // {
    //     header("Location: sc_pwd_record.php");
    // } 
?>
<?php include('include/admin/header.php'); ?>
    ...
    {
        $key = $_GET['scid'];
        $MYsql = "SELECT * FROM `sc_tbl` WHERE `id` = ?";
        $MYstmt = $db->prepare($MYsql);
        $MYstmt->bind_param('i',$key);
        $MYstmt->execute();
        $MYstmt->bind_result($id,$aipcode,$program,$implemeting,$quarter1,$quarter2,
        ...
        $MYstmt->close();
            ...
            //         $implemeting = $data['implemetingoffice'];
                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left mx-auto">
                                      <h2 class="text-center text-uppercase">sc update Form</h2>
                                    </div>
                                </div>
                            </div>
                            <!--<div class="col-md-offset-2">-->
...
<input type="hidden" id="bcode" name="bcode" class="form-control" value="<?php echo $brgycode ?>">
        <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                <input type="text" id="reference-code" name="referencecode" class="form-control" 
                value="<?php echo $aipcode ?>" maxlength="50">
            </div>
        </div>
         ...
         <div class="row form-group">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $implemeting ?>" maxlength="30">
            </div>
        </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $quarter1 ?>" maxlength="12">
            </div>
        </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $quarter2 ?>" maxlength="12">
            </div>
        </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $quarter3 ?>" maxlength="12">
            </div>
        </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                ...
                value="<?php echo $quarter4 ?>" maxlength="12">
            </div>
        </div>
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-primary btn-sm" name="updatesc">
