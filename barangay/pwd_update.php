...
// if(!isset($_GET['pwdid']) && empty($_GET['pwdid']))
//     {
...
if(isset($_GET['pwdid']))
    {
        $key = $_GET['pwdid'];
        $MYsql = "SELECT * FROM `pwd_tbl` WHERE `id` = ?";
                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left mx-auto">
                                      <h2 class="text-center text-uppercase">pwd update Form</h2>
                                    </div>
                                </div>
                            </div>
                            <!--<div class="col-md-offset-2">-->
...
<input type="hidden" id="bcode" name="bcode" class="form-control" value="<?php echo $brgycode ?>">
        <div class="row form-group">
         ...
         <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
               ...
               <textarea name="program" class="form-control" id="program" rows="5"><?php echo $program ?></textarea>
            </div>
        </div>
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-primary btn-sm" name="updatepwd" >
