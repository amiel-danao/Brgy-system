                ...
                <div class="col-lg-12" id="org">
                    <div class="card">
                        <div class="card-header text-center bg-light">
                            <strong>Barangay Organizational Chart of Barangay <?php echo $brgyname ?> in Maragondon Cavite</strong>
                        </div>
                        <div class="card-body card-block border-light">
 ...
 while ($dataz = $resultz->fetch_assoc())
    {
        ...
        $position = $dataz['position']; 
        $picture = $dataz['picture'];    ?>
            <div class="col-md-3 mx-auto organizational mb-0">
                <div class="card mx-0 h-75 w-100">
     ...
     ?>
        ...
        <div class="row">
            <div class="col-md-12 p-0">
                <div class="copyright bg-light">
                     <a href="include/print_function/barangay_official_organizational.php?barangaycode=<?php echo $brgycode ?>&barangayname=<?php echo $brgyname?>" class="btn btn-primary" target="_blank">Print the Organziational Chart!</a>
                </div>
            </div>
        </div>
...
//     window.location.href='organizational.php';
// }
</script>
    <!-- Jquery JS-->
