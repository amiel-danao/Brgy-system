                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left mx-auto">
                                      <h2 class="text-center text-uppercase">sk Add Form</h2>
                                    </div>
                                </div>
                            </div>
                            <!--<div class="col-md-offset-2">-->
...
<input type="hidden" id="bcode" name="bcode" class="form-control" value="<?php echo $brgycode ?>">
        <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                <input type="text" id="gap" name="gap"  class="form-control" maxlength="150">
            </div>
        </div>
         ...
         <div class="row form-group">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                <input type="text" id="result" name="result" class="form-control" maxlength="100">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                <input type="text" id="amount" name="amount"  class="form-control" maxlength="10">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                <input type="text" id="source" name="source"  class="form-control" maxlength="30">
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                <input type="text" id="period" name="period"  class="form-control" maxlength="50">
            </div>
        </div>
          ...
          <div class="row form-group">
            ...
            <div class="col-12 col-md-8">
                <input type="text" id="budget" name="budget"  class="form-control" maxlength="10">
        ...
        <div class="card-footer">
		    <button type="submit" class="btn btn-primary btn-sm" name="addsk" value="ADD">
